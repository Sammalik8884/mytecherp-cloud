...
content = content.replace(oldListStartRegex, newListStart);

// Let's accurately replace the ending of the DPR List Section
...
console.log("DPR Card and List patched successfully and safely!");
