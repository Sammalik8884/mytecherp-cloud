    ...
    public class QuotationExcelService
    {
        public byte[] GenerateExcel(QuotationDto quote)
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                ws.Column(7).Width = 18; // Amount

                bool showRef = quote.Items.Any(i => !string.IsNullOrWhiteSpace(i.ReferenceNumber));
                if (!showRef)
                {
                ...
                void DrawSection(string title, System.Collections.Generic.List<QuotationItemDto> items)
                {
                    ...
                    foreach (var item in items)
                    {
                        ...
                        ws.Cells[currentRow, 4].Value = unitText;
                        ...
                        ws.Cells[currentRow, 6].Value = item.UnitPrice;
                        ws.Cells[currentRow, 6].Style.Numberformat.Format = "#,##0.00";
                        ws.Cells[currentRow, 6].Style.Font.Color.SetColor(highlightGoldColor);

                        ws.Cells[currentRow, 7].Value = item.LineTotal;
                    ...
                    ws.Cells[currentRow, 1, currentRow, 7].Style.Font.Bold = true;
                    ws.Cells[currentRow, 1, currentRow, 7].Style.Font.Color.SetColor(brandColor);
                    ws.Cells[currentRow, 1, currentRow, 7].Style.Fill.PatternType = ExcelFillStyle.Solid;
                    ws.Cells[currentRow, 1, currentRow, 7].Style.Fill.BackgroundColor.SetColor(brandLightColor);

                    ws.Cells[currentRow, 7].Value = sectionTotal;
                    ws.Cells[currentRow, 7].Style.Numberformat.Format = "#,##0.00";
                ...
                ws.Cells[currentRow, 6].Value = "FINANCIAL SUMMARY";
                ws.Cells[currentRow, 6].Style.Font.Bold = true;
                ws.Cells[currentRow, 6].Style.Font.Color.SetColor(Color.White);
                ws.Cells[currentRow, 6].Style.Fill.PatternType = ExcelFillStyle.Solid;
                ws.Cells[currentRow, 6].Style.Fill.BackgroundColor.SetColor(ColorTranslator.FromHtml("#4B5563"));
                currentRow++;

                void DrawSummaryRow(string label, decimal value, bool isGrandTotal = false)
                {
                    ws.Cells[currentRow, 6].Value = label;
                    ws.Cells[currentRow, 7].Value = value;
                    ws.Cells[currentRow, 7].Style.Numberformat.Format = "#,##0.00";

                    ws.Cells[currentRow, 6, currentRow, 7].Style.Border.BorderAround(ExcelBorderStyle.Thin, ColorTranslator.FromHtml("#D1D5DB"));

                    if (isGrandTotal)
                    {
                        ws.Cells[currentRow, 6, currentRow, 7].Style.Font.Bold = true;
                        ws.Cells[currentRow, 6, currentRow, 7].Style.Font.Color.SetColor(Color.White);
                        ws.Cells[currentRow, 6, currentRow, 7].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        ws.Cells[currentRow, 6, currentRow, 7].Style.Fill.BackgroundColor.SetColor(ColorTranslator.FromHtml("#4B5563"));
                    }
                    else
                    {
                        ws.Cells[currentRow, 6, currentRow, 7].Style.Fill.PatternType = ExcelFillStyle.Solid;
                        ws.Cells[currentRow, 6, currentRow, 7].Style.Fill.BackgroundColor.SetColor(ColorTranslator.FromHtml("#F3F4F6"));
                    }
                    currentRow++;
                }
