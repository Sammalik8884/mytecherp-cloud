...
const oldListRegex = /<div className="space-y-4">\s*\{dprLists\.map\(\(report\) => \([\s\S]*?<\/div>\s*\)\}\s*<\/div>/;
                                                    ...
                                                    <tr key={report.id} className="border-b border-border last:border-0 hover:bg-secondary/20 transition-colors">
                                                        ...
                                                        <td className="px-4 py-3 text-center">
                                                            <div className="flex flex-col space-y-1">
                                                                ...
                                                                <button onClick={() => handleDeleteDpr(report.id)} className="text-red-500 hover:text-red-700 text-xs mt-1 transition-colors">Delete</button>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ))}
...
console.log("ProjectDocumentsPage patched successfully!");
