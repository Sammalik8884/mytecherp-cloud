...
const SIDEBAR_ITEMS: SidebarItem[] = [
    ...
    { label: "ARF Exceptions", href: "/arf-exceptions", icon: ShieldAlert, allowedRoles: ["None"], allowedEmails: ["munawar.hasan@mytecheng.com"] },
    ...
    { label: "Manage Cheques", href: "/accounts/manage-cheques", icon: CreditCard, allowedRoles: ["CEO", "Accounts Head"], allowedEmails: ["asma@mytecheng.com", "faisal.ghani@mytecheng.com"] },
