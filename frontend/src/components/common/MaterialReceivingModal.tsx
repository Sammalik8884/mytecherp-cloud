...
export const MaterialReceivingModal = () => {
    const [isOpen, setIsOpen] = useState(false);
    const [sites, setSites] = useState<SiteDto[]>([]);
    const [siteId, setSiteId] = useState<number | "">("");
    
    // Initialize 1 empty row by default
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-background/80 backdrop-blur-sm p-4">
            <div className="bg-card w-full max-w-5xl rounded-xl shadow-2xl border border-border flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 overflow-y-auto flex-1">
                    <form id="material-receiving-form" onSubmit={handleSubmit} className="space-y-6">
                        <div>
